...
while True:
    ...
    for marker in markers:
        if(marker[0] < 320 and marker[1] < 240):
            top_left = marker
        elif(marker[0] > 320 and marker[1] < 240):
            top_right = marker
        elif(marker[0] < 320 and marker[1] > 240):
            bottom_left = marker
        elif(marker[0] > 320 and marker[1] > 240):
    ...
    x_squared = (float(top_right[0])-float(top_left[0]))**2
    y_squared = (float(top_right[1])-float(top_left[1]))**2
    #conversion = (18/(((x_squared + y_squared)**0.5)) 
